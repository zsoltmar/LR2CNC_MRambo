...
#define CUSTOM_USER_MENUS
  ...
  #define USER_DESC_2 "Engage Steppers"
  #define USER_GCODE_2 "M17 X Y Z"

  #define USER_DESC_3 "Engage X"
  #define USER_GCODE_3 "M17 X"
  
  #define USER_DESC_4 "Engage Y"
  #define USER_GCODE_4 "M17 Y"
  
  #define USER_DESC_5 "Engage Z"
  #define USER_GCODE_5 "M17 Z"

  #define USER_DESC_6 "Disengage X"
  #define USER_GCODE_6 "M18 X"
  
  #define USER_DESC_7 "Disengage Y"
  #define USER_GCODE_7 "M18 Y"
  
  #define USER_DESC_8 "Disengage Z"
  #define USER_GCODE_8 "M18 Z"
